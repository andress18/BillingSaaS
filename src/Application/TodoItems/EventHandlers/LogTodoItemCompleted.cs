using BillingSaaS.Domain.Events;
using Microsoft.Extensions.Logging;

namespace BillingSaaS.Application.TodoItems.EventHandlers;
...
public class LogTodoItemCompleted : INotificationHandler<TodoItemCompletedEvent>
{
    ...
    {
        _logger.LogInformation("BillingSaaS Domain Event: {DomainEvent}", notification.GetType().Name);
